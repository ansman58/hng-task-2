...
class PersonController {
    ...
    static async index(req, res) {
        try {
            const getUsers = ormconfig_1.AppDataSource.getRepository(Person_1.Users);
